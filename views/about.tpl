...
<h4>Grigireva Olga</h4>
<<<<<<< HEAD
<p>My part was to develop a program that could find the shortest spanning tree of a given graph using Kruskal's algorithm. I also made the main page and this page.</p>
<h4>Remneva Alina</h4>
=======
